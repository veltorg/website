...
export type FeatureImageFilter = {
  _key?: InputMaybe<StringFilter>;
  _type?: InputMaybe<StringFilter>;
...
export type FeatureImageSorting = {
  _key?: InputMaybe<SortOrder>;
  _type?: InputMaybe<SortOrder>;
...
export type Post = Document & {
  ...
  /** Date the document was last modified */
  _updatedAt?: Maybe<Scalars['DateTime']>;
  articleBodyRaw?: Maybe<Scalars['JSON']>;
  author?: Maybe<Array<Maybe<Person>>>;
  headline?: Maybe<Scalars['String']>;
  image?: Maybe<FeatureImage>;
  slug?: Maybe<Slug>;
};
...
export type PostFilter = {
  ...
  image?: InputMaybe<FeatureImageFilter>;
...
export type PostSorting = {
  ...
  image?: InputMaybe<FeatureImageSorting>;
...
export type GetAllPostSlugsQuery = {
  __typename?: 'RootQuery';
  posts: Array<{
    __typename?: 'Post';
...
export const GetPostsBySlugDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetPostsBySlug' },
      variableDefinitions: [
        {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'articleBodyRaw' },
                },
              ],
            },
          },
...
} as unknown as DocumentNode<GetPostsBySlugQuery, GetPostsBySlugQueryVariables>;
export const GetAllPostSlugsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetAllPostSlugs' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
